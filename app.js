...
const next = cookies => {
    ...
    request.get(currUrl, reqOpts, (error, response, body) => {
        ...
        let data = {};
        let contImgSrc = null;
        let contImgExt = ""; // изначально расширение изображение неизвестно
        ...
        try {
            ...
            savePath = path.join(__dirname, 'pages', fileName.concat('.html'));
            ...
            contImgSrc = htmlBody.querySelector('.entry-content > img').getAttribute('src');
